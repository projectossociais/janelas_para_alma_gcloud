...
As quatro opções de cada pergunta são deliberadamente niveladas em
comprimento e estrutura gramatical -- nunca deve ser possível adivinhar a
resposta certa só por ser a única frase desenvolvida do conjunto.
"""
