      ...
      <div className="container">
        ...
        <article className="max-w-4xl mx-auto text-lg text-muted-foreground leading-relaxed space-y-6">
          <p>
            ...
            global, afetando cerca de 2 a 4% da população. Apesar da sua
          ...
          <p>
            ...
            enquanto o outro mantém a fixação correta. Este desvio pode ser
          ...
          <p>
            ...
            desenvolvimento visual — é essencial para evitar complicações que,
          ...
          <p>
            ...
            multifatoriais. Entre os fatores mais determinantes destacam-se a
            predisposição genética e a história familiar da condição; os erros
            refrativos não corrigidos, em particular a hipermetropia
            ...
            neurológicas que afetam os nervos cranianos responsáveis pela
            motricidade ocular.
          </p>
          <p>
            ...
            consequência de outras patologias oculares — cataratas congénitas
          ...
          <p>
            A classificação mais comum do estrabismo assenta na direção do
            desvio ocular:
          </p>
          ...
          <p>
            Para além da direção, o estrabismo classifica-se ainda quanto à
            ...
            subtipo exige uma avaliação específica, que influencia diretamente
          ...
          <p>
            ...
            desenvolvimento visual — que se estende sensivelmente até aos 7-8
            anos — a perda de acuidade nesse olho pode tornar-se
            permanente, mesmo com correção ótica adequada mais tarde.
          </p>
          <p>
            O desalinhamento impede ainda a fusão correta das duas imagens
            retinianas, comprometendo o desenvolvimento da visão binocular e
            da estereopsia — a perceção de profundidade — com impacto em
          ...
          <p>
            ...
            entrevistas de emprego e nas interações sociais do dia a dia. A
            autoestima e a saúde mental são, com frequência, gravemente
            afetadas, uma vez que o desalinhamento ocular influencia
          ...
          <ul className="list-disc pl-6 space-y-2 marker:text-teal">
            <li>
              <strong className="text-foreground">Correção ótica</strong> —
              óculos ou lentes de contacto para corrigir erros refrativos
            ...
            <li>
              ...
              — injetada nos músculos extraoculares, enfraquece
              temporariamente a sua ação e permite corrigir determinados
            ...
            <li>
              ...
              em casos selecionados, nomeadamente na insuficiência de
              convergência.
            </li>
            <li>
